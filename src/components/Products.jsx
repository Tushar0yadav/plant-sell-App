...
const Products = () => {
  return (
    <div className="flex flex-wrap lg:px-20 gap-4 lg:gap-10 justify-center">
      {products.map((item) => {
        return <ProductCard2 key={item?.name} item={item} />;
      })}
    </div>
  );
};
...
const products = [
  {
    imageUrl:
      "https://www.ugaoo.com/cdn/shop/products/AtlantisPlanter-PastelBlue.jpg?v=1680434558&width=375",
  ...
  {
    imageUrl:
      "https://www.ugaoo.com/cdn/shop/products/AtlantisPlanter-PastelPink_b9cb7567-785a-464c-88f9-d5282d4668d1.jpg?v=1680427445&width=375",
    name: "Fittonia Plant",
    price: 12.49,
  },
  {
    imageUrl:
      "https://www.ugaoo.com/cdn/shop/products/areca-palm-plant-xl-31798831349892.jpg?v=1675575726&width=375",
    name: "Areca Plant",
    price: 12.49,
  },
  {
